...
@Deprecated
public class SimedModalContainer extends AjaxDynamicElement {

	private String _updateContainerID = null;
	private String _url = null;

	public SimedModalContainer(String name, NSDictionary<String, WOAssociation> associations, WOElement children) {
	...
	protected void addRequiredWebResources(WOResponse response, WOContext context) {
		...
		MTAjaxUtils.addScriptResourceInHead(context, context.response(), "SimedFoundation", MTAjaxUtils.MOOTOOLS_CORE_JS);
		MTAjaxUtils.addScriptResourceInHead(context, context.response(), "SimedFoundation", MTAjaxUtils.MOOTOOLS_MORE_JS);
		MTAjaxUtils.addScriptResourceInHead(context, context.response(), "SimedFoundation", "scripts/plugins/bootstrap/ui/Bootstrap.js");
		MTAjaxUtils.addScriptResourceInHead(context, context.response(), "SimedFoundation", "scripts/plugins/bootstrap/behaviors/Behavior.js");
		MTAjaxUtils.addScriptResourceInHead(context, context.response(), "SimedFoundation", "scripts/plugins/bootstrap/behaviors/Behavior.BS.Popup.js");
		MTAjaxUtils.addScriptResourceInHead(context, context.response(), "SimedFoundation", "scripts/plugins/bootstrap/ui/Bootstrap.Popup.js");
		MTAjaxUtils.addScriptResourceInHead(context, context.response(), "SimedFoundation", "scripts/plugins/bootstrap/ui/CSSEvents.js");
		MTAjaxUtils.addScriptResourceInHead(context, context.response(), "SimedFoundation", MTAjaxUtils.MOOTOOLS_WONDER_JS);

		Boolean useDefaultCSS = (Boolean) valueForBinding("useDefaultCSS", Boolean.TRUE, context.component());
		if (useDefaultCSS.booleanValue()) {
			AjaxUtils.addStylesheetResourceInHead(context, context.response(), "SimedFoundation", "scripts/plugins/bootstrap/modal/modal.css");
		}
